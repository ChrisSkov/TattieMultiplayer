...
public class AttackAnimBehavior : StateMachineBehaviour
{
    ...
    public int colliderChildNumber = 7;
    MeshCollider weaponArc;
    // OnStateEnter is called when a transition starts and the state machine starts to evaluate this state
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        weaponArc = animator.gameObject.transform.GetChild(colliderChildNumber).gameObject.GetComponent<MeshCollider>();
        weaponArc.gameObject.GetComponent<ColliderHit>().hasHit = false;
    }
